...
- **Swing**: A graphical user interface (GUI) framework for building the front-end of the application.
...
- **Front-end**: Built using **Swing** to provide an interactive UI, where users can add friends, make posts, and view recommendations.
...
3. **Run the Project:**
   ...
   - Run the main application file to start the front-end (Swing) and back-end (graph logic).
