...
public class CurrentUserPostsController {
    ...
    public void initialize() {
        // Fetch posts for the current user using their ID
        ObservableList<Post> posts = FXCollections.observableArrayList(Database.getPostsForId(currentUser.getUserId()));
